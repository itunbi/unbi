...
$query = "SELECT program_studi, tahun, COUNT(*) as total 
          FROM pengajuan_penelitian";
if ($tahun_filter) {
    $query .= " WHERE tahun = $tahun_filter";
}
$query .= " GROUP BY program_studi, tahun";
...
<body>
      ...
      <div class="accordion-item">
        ...
        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
          <div class="accordion-body">
            ...
            <h2 class="mb-4">Laporan <br> Penelitian Dosen </h2>
            <!-- Navbar -->
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="rekap-monev.php">Hasil Monev</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container mt-5">
        <h2 class="text-center">Statistik Penelitian</h2>
        ...
        const config = {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Statistik Penelitian Berdasarkan Program Studi dan Tahun'
                    }
                }
            },
        };
