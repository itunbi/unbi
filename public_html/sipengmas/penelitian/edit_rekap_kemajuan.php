...
$id = $_POST['id'];
$query = "SELECT * FROM kemajuan_penelitian WHERE id = '$id'";
...
<div class="container mt-5">
    <h3>Edit Data</h3>
    <form method="POST" action="update_rekap_kemajuan.php">
        ...
        <div class="mb-3">
        <label for="skema_penelitian" class="form-label">Skema Penelitian</label>
        <input type="text" class="form-control" id="skema_penelitian" name="skema_penelitian" value="<?php echo $row['skema_penelitian']; ?>" required>
        </div>
        ...
        <a href="rekap-laporan-kemajuan.php" class="btn btn-secondary">Kembali</a>
    </form>
</div>
</body>
</html>
