...
$query = "SELECT * FROM laporan_kemajuan WHERE 1";
...
$total_sql = !empty($tahun_filter) 
    ? "SELECT COUNT(*) AS total FROM laporan_kemajuan WHERE tahun = '$tahun_filter'" 
    : "SELECT COUNT(*) AS total FROM laporan_kemajuan";
$total_result = $conn->query($total_sql);
$total_row = $total_result->fetch_assoc();
$total_penelitian = $total_row['total'];

// Query untuk menghitung total seluruh penelitian
$total_all_sql = "SELECT COUNT(*) AS total FROM laporan_kemajuan";
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <select name="tahun" class="form-select" id="tahun">
                        ...
                        $query_tahun = "SELECT DISTINCT tahun FROM laporan_kemajuan ORDER BY tahun DESC";
    ...
    <form method="GET" class="mb-3">
      ...
      <thead class="table-dark">
        <tr>
          ...
          <th>Luaran Tercapai</th>
          <th>Tahun</th>
          <th>Program Studi</th>
          <th>Dokumen Hasil Penelitian</th>
          <th>Aksi</th>
        </tr>
      </thead>
      <tbody>
